...
All files must be kept in the folder for CENTURY to run. That includes schedule, weather, site and soil characteristic files, as well as two compiled '.exe' programs ('century_47.exe' and 'list100_47.exe'). To run the CENTURY model you must follow the examples and the enclosed documentation.
