...
3. Weather file, with extension '.wth', that includes monthly data for precipitation and minimum and maximum temperature for the site.
...
All required files must be kept in the same folder for CENTURY to run. That includes schedule, weather, site and soil characteristic files (see numbered list above), as well as two compiled '.exe' programs ('century_47.exe' and 'list100_47.exe'). To run the CENTURY model on a command window (not covered here) without the use of this package it is recommended that you follow the examples and the enclosed documentation.
